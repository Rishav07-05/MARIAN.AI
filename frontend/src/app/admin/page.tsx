            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-medium text-white">MARIAN Local Inference Pipeline</div>
                    <div className="text-xs text-gray-400">Local Model Active • MARIAN 3 Omni</div>
                  </div>
                </div>
                <span className="px-2.5 py-1 rounded-lg text-xs font-medium bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                  Active
