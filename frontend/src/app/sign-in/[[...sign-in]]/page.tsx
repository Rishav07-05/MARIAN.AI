...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-[#0B0C10] flex flex-col justify-center items-center p-4 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-tr from-cyan-500/10 via-indigo-500/10 to-transparent blur-3xl rounded-full pointer-events-none" />
      ...
      <div className="mb-8 text-center z-10 space-y-2">
        ...
        <p className="text-sm text-gray-400 max-w-sm">
          Sign in to your account with Clerk Authentication.
        </p>
      </div>

      <div className="z-10 shadow-2xl rounded-2xl border border-white/10 overflow-hidden bg-gray-900/60 backdrop-blur-xl">
        <SignIn
          appearance={{
            elements: {
